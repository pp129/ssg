app.controller('driver', ['$scope', 'toaster', '$modal','commonTools',
        ...
        $scope.deleteList = function () {
            ...
            if (deleteIDs.length <= 0) {
                ...
                modalInstance.result.then(function () { // 确定后操作
                    $.ajax({
                        url: '../common/driver/delete',
                        type: 'POST',
                        async: false,
                        data: {driverids: deleteIDs},
...
app.controller('funModalInstanceCtrl', ['$scope', '$modalInstance', 'items',
    function ($scope, $modalInstance, items) {
        ...
        $scope.formData = {};
        if (items.type === 'add') {
            ajaxUrl = '../common/driver/save';
        } else if (items.type === 'update') {
            ajaxUrl = '../common/driver/update';
