angular.module('multiselect-searchtree').run(['$templateCache', function ($templateCache) {
    ...
    $templateCache.put('multiselect-searchtree.tpl.html',
    ...
    $templateCache.put('tree-item.tpl.html',
      "<li>\n" +
      "    <div class=\"item-container\" ng-class=\"{active: item.isActive, selected: item.selected}\"\n" +
      "         ng-click=\"clickSelectItem(item, $event)\" ng-mouseover=\"onMouseOver(item, $event)\" ng-dblclick=\"closeTree(item, $event)\">\n" +
